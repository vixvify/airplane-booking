...
Additional checks cover all client commands, validation, ownership, multi-seat transactions, the three experiment modes, stable load-test client IDs and seat mappings, IPC timeouts and cleanup, concurrent sessions, and Demo 1's final mix of available and reserved seats.
